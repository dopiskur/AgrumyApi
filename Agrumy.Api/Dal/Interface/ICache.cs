...
namespace api.Dal.Interface
{
    ...
    {
        /// <summary>Never returns null: a cache miss comes back as a fresh DeviceCache (ConfigVersion=0,
        /// apiAuth=null), matching the pre-#72 behaviour every caller already relies on.</summary>
