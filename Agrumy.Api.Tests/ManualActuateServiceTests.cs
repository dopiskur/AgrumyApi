...
/// Exercises ManualActuateService directly - no HTTP/controller plumbing, no database (IDeviceUnitRepository is mocked).
public class ManualActuateServiceTests
{
    ...
    private static Device ControllerDevice(int id, int idZone) => new() { IDDevice = id, DeviceUnitZoneID = idZone, DeviceControllerEnabled = true };
    ...
    {
        _units.Setup(u => u.DeviceUnitZoneGetControllerAsync(10)).ReturnsAsync(ControllerDevice(1, 10));
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7 });
    ...
    {
        _units.Setup(u => u.DeviceUnitZoneGetControllerAsync(10)).ReturnsAsync(ControllerDevice(1, 10));
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, HeatingMaxRunSeconds = 1800 });
    ...
    public async Task Target_Mode_Without_MaxRunSeconds_Configured_Is_Refused()
    {
        ...
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, HeatingMaxRunSeconds = null });
    ...
    {
        _units.Setup(u => u.DeviceUnitZoneGetControllerAsync(10)).ReturnsAsync(ControllerDevice(1, 10));
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, WaterPumpMaxRunSeconds = 1800 });
        ...
        _units.Setup(u => u.DeviceUnitZoneConfigVersionBumpAsync(10)).Returns(Task.CompletedTask);
    ...
    {
        _units.Setup(u => u.DeviceUnitZoneGetControllerAsync(10)).ReturnsAsync(ControllerDevice(1, 10));
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, WaterPumpMaxRunSeconds = 60 });
    ...
    public async Task Duration_Mode_With_No_MaxRunSeconds_Configured_Uses_Requested_Duration_Unclamped()
    {
        ...
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, WaterPumpMaxRunSeconds = null });
    ...
    {
        _units.Setup(u => u.DeviceUnitZoneGetControllerAsync(10)).ReturnsAsync(ControllerDevice(1, 10));
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, VentilationMaxRunSeconds = 1800 });
    ...
    {
        _units.Setup(u => u.DeviceUnitGetControllersAsync(3)).ReturnsAsync(new List<Device>
        {
            ControllerDevice(1, 10),
            ControllerDevice(2, 11),
        });
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, WaterPumpMaxRunSeconds = 1800 });
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(11)).ReturnsAsync((DeviceUnitZone?)null); // deleted zone race, defensively skipped
        ...
        Assert.Equal(ManualActuateOutcome.Success, result.Outcome);
        Assert.Equal([1], result.AffectedDeviceIds);
        // Strict mock: ManualOverrideStartAsync/DeviceUnitZoneConfigVersionBumpAsync for device 2/zone 11 would throw if called - only device 1 should have been targeted.
    }
    ...
    public async Task Unit_FanOut_Target_Mode_One_Zone_Missing_MaxRunSeconds_Still_Starts_The_Other_And_Bumps_It()
    {
        ...
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(10)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 10, TenantID = 7, HeatingMaxRunSeconds = 1800 });
        _units.Setup(u => u.DeviceUnitZoneGetByIdAsync(11)).ReturnsAsync(new DeviceUnitZone { IDDeviceUnitZone = 11, TenantID = 7, HeatingMaxRunSeconds = null });
        ...
        // Strict mock: ManualOverrideStartAsync/DeviceUnitZoneConfigVersionBumpAsync for device 2/zone 11 would throw if called.
    }
    ...
    public async Task Stop_With_No_Controller_Is_A_NoOp()
    {
        ...
        // Strict mock: ManualOverrideStopAsync/DeviceUnitZoneConfigVersionBumpAsync would throw if called.
    }
    ...
    public async Task Stop_With_Controller_Stops_And_Bumps_ConfigVersion()
    {
        ...
        _units.Verify(u => u.DeviceUnitZoneConfigVersionBumpAsync(10), Times.Once);
    }
}
